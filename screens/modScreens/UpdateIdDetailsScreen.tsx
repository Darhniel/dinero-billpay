...
type UploadIdScreenProps = NativeStackScreenProps<RootStackParamList, 'UpdateIdDetails'>;

const UpdateIdDetailsScreen: React.FC<UploadIdScreenProps> = ({ navigation }) => {
    ...
    async function updateKYC() {
        ...
        try {
            const response = await fetch('https://dinero-backend-production.up.railway.app/api/v1/auth/kyc/verify', {
                method: 'POST',
                headers: {
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            navigation.reset({
                                ...
                                routes: [{
                                    name: 'Main', state: {
                                        routes: [{ name: 'Home', params: { accessToken: AsyncStorage.getItem('accessToken') } }]
                                    }
                                }]
                            })
                        }}
...
export default UpdateIdDetailsScreen;