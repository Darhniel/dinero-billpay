...
type InternetDetailsScreenProps = NativeStackScreenProps<RootStackParamList, 'InternetDetails'>;


const InternetDetailsScreen: React.FC<InternetDetailsScreenProps> = ({ navigation, route }) => {
    ...
    const [user, setUser] = useState({ amount: "", meterNo: "", meterType: "", email: "", phone: "", decoderNo: "", decoderPackage: "", dataPlan: "", userId: "", image: logo, name: network, transaction: "INTERNET"});
    ...
    return (
        <KeyboardAwareScrollView style={styles.container} ref={scrollRef} keyboardShouldPersistTaps="handled">
            ...
            <View>
                <Text style={styles.label}>User ID/Number</Text>
                <TextInput
            ...
            <View style={{ marginTop: verticalScale(8) }}>
                ...
                <Dropdown
                    ...
                    onChange={item => setUser(prevState => ({ ...prevState, dataPlan: item.name, userId: item.id, amount: item.amount }))}
                    style={styles.input}
...
export default InternetDetailsScreen;